...
| DIFF-TEST-001 | docx content diff checked tasks need real tests | `.kiro/specs/docx-content-diff/tasks.md` | `ContentDiffService`, `DocxTextExtractor`, `SegmentVersionService` | `ContentDiffServiceTest` (WS-04-T01); `DocxTextExtractorTest` (WS-04-T02); `SegmentVersionService` tests still pending (e.g. WS-04-T06) | `docs/segment-version-api.md` to update | In Progress |

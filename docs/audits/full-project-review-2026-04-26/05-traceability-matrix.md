...
| --- | --- | --- | --- | --- | --- | --- |
| SEC-OO-001 | OnlyOffice callbacks must verify source and must not anonymously overwrite files | WS-01 (JWT + URL policy + bounded download) | `OnlyOfficeService`, `CallbackDocumentDownloadHelper`, `CompositeTemplateController`, `OnlyOfficeController`, `SecurityConfig` | `OnlyOfficeServiceTest`, `CallbackDocumentDownloadHelperTest`, `CompositeTemplateControllerSegmentCallbackTest` | `07-iteration-log.md` (WS-01-T01, WS-01 Phase 1, WS-01-T04, WS-01-T06–T09) | Verified |

<template>
  <div class="component-panel">
    ...
    <div class="panel-section">
      ...
      <div ref="segmentListRef" class="component-list" data-group="segments">
        <div
    ...
    <div class="panel-section">
      ...
      <div ref="controlListRef" class="component-list" data-group="controls">
        <div
...
import { Document, DArrowRight, Postcard, Tickets, Odometer } from '@element-plus/icons-vue'
...
const controlNodes = [
  { type: 'page-break', labelKey: 'workspace.design.canvas.pageBreak', icon: DArrowRight },
...
onBeforeUnmount(() => {
  segmentSortable?.destroy()
  controlSortable?.destroy()
})
</script>
...
.component-item--segment .el-icon,
.component-item--segment .component-label {
  margin-left: 4px;
}
